...
inherit eutils gnome2-utils multilib python vala virtualx autotools

DESCRIPTION="xkb support for ibus"
HOMEPAGE="https://github.com/fujiwarat/ibus-xkb"
SRC_URI="http://ibus.googlecode.com/files/${P}.tar.gz"

LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~ia64 ~ppc ~ppc64 ~sparc ~x86 ~x86-fbsd"
IUSE="dconf deprecated +gconf +gtk3 gtk +introspection nls +python test +vala +X"
